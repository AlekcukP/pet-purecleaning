...
<section class="step_two">
    ...
    <div class="step_item">
        <div class="step_item_container">
            <div class="step_item_type">
                <h3>Home residents</h3>
            </div>
            <div class="step_item_content">
                <div class="step_item_content_row">
                    <div class="step_item_header">
                        <h5>Have any dogs or cats?</h5>
                    </div>
                ...
                <div class="step_item_content_row">
                    <div class="step_item_header">
                        <h5>How many adults reside at your location?</h5>
                    </div>
                    <div class="step_item_btns">
                        <div class="radio">
    ...
    <div class="step_item">
        <div class="step_item_container">
            <div class="step_item_type">
                <h3>Home Cleanliness</h3>
            </div>
            <div class="step_item_content">
                <div class="steps_item_content_row">
                    <div class="step_item_header">
                        <h5>How would your current home cleanliness?</h5>
                    </div>
                    <fieldset class="step_item_btns">
    ...
    <div class="step_item">
        <div class="step_item_container">
            <div class="step_item_type">
                <h3>Cleaning before</h3>
            </div>
            <div class="step_item_content">
                <div class="steps_item_content_row">
                    <div class="step_item_header">
                        <h5>Did you had a professioanl cleaning in past 2 monthes?</h5>
                    </div>
                    <fieldset class="step_item_btns">
                        <div class="radio-round">
                            <label for="clean_before_yes"></label>
                            <input type="radio" name="lean_before_yes" id="clean_before_yes">
                        </div>
                        <div class="radio-round">
                            <label for="clean_before_no"></label>
                            <input type="radio" name="clean_before_no" id="clean_before_no">
                        </div>
                    </fieldset>
                </div>
            </div>
    ...
    <div class="step_item">
        <div class="step_item_container">
            ...
            <div class="step_item_content">
                <div class="steps_item_content_row">
                    <div class="step_item_header">
                        <h5>Do you have any photos of your home? (optional)</h5>
                    </div>
                    <div class="step_item_text">
                        <p>You can upload more then one photo at a time. Up to 58 photos in total.</p>
                    </div>
